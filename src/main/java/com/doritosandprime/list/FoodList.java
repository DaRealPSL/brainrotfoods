...
public class FoodList {
    ...
    public static final ConsumableComponent PRIME_CONSUMABLE = ConsumableComponents.drink()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.ABSORPTION, 20 * 60, 1), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.ABSORPTION, 20 * 60, 9), 0.1F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 30, 2), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20 * 120, 1), 1.0F))
            .build();
    ...
    public static final ConsumableComponent DORITO_CONSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20 * 120, 1), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.RESISTANCE, 20 * 60, 1), 1.0F))
            .build();
    ...
    public static final ConsumableComponent FEASTABLES_CONSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.GLOWING, 20 * 30, 1), 1.0F))
            .build();
    ...
    public static final ConsumableComponent LUNCHLY_CONSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.NAUSEA, 20 * 15, 1), 0.8F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.POISON, 20 * 20, 1), 0.8F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.BLINDNESS, 20 * 20, 1), 0.8F))
            .build();
    ...
    public static final ConsumableComponent MOUNTAIN_DEW_CONSUMABLE = ConsumableComponents.drink()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.SPEED, 20 * 20, 1), 1.0F)) // Speed II
            // for 20s
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.JUMP_BOOST, 20 * 10, 0), 1.0F)) // Jump
            // Boost
            // I for
            // 10s
            .build();
    ...
    public static final ConsumableComponent MANGO_CONSUMABLE = ConsumableComponents.food()
            ...
            // StatusEffectInstance(StatusEffects.REGENERATION, 20 * 5, 0), 0.3F)) //
            // Regeneration I for 5s (30% chance)
            .build();
    ...
    public static final ConsumableComponent MANGO_SMOOTHIE_CONSUMABLE = ConsumableComponents.drink()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.ABSORPTION, 20 * 30, 0), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 10, 0), 0.6F))
            .build();
    ...
    public static final ConsumableComponent FLAMIN_CHEETOS_CONSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.SPEED, 20 * 15, 0), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.NAUSEA, 20 * 5, 0), 0.8F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20 * 10, 0), 1.0F))
            .build();
    ...
    public static final ConsumableComponent GRIMACE_SHAKE_CONSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 10, 1), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.NAUSEA, 20 * 5, 0), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.SLOWNESS, 20 * 4, 0), 1.0F))
            .build();
    ...
    public static final ConsumableComponent MONSTER_ENERGY_COMSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.SPEED, 20 * 25, 1), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.HASTE, 20 * 20, 0), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.STRENGTH, 20 * 10, 0), 1.0F))
            .build();
    ...
    public static final ConsumableComponent OHIO_BURGER_CONSUMABLE = ConsumableComponents.food()
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.STRENGTH, 20 * 15, 1), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 15, 1), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.DARKNESS, 20 * 5, 0), 1.0F))
            .consumeEffect(new ApplyEffectsConsumeEffect(
                    new StatusEffectInstance(StatusEffects.NAUSEA, 20 * 3, 0), 1.0F))
            .build();

    public static final FoodComponent ohio_burger_component = new FoodComponent.Builder()
            .nutrition(14)
