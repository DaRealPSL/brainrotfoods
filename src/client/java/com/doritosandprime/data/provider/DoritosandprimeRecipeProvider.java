...
public class DoritosandprimeRecipeProvider extends FabricRecipeProvider {
    public DoritosandprimeRecipeProvider(FabricDataOutput output,
            ...
            public void generate() {
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.prime)
                        ...
                        .criterion(hasItem(Items.GLASS_BOTTLE),
                                conditionsFromItem(Items.GLASS_BOTTLE))
                        .offerTo(exporter);
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.feastables)
                        ...
                        .pattern(" S ")
                        .pattern(" W ")
                        .criterion(hasItem(Items.COCOA_BEANS),
                                conditionsFromItem(Items.COCOA_BEANS))
                        .offerTo(exporter);
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.lunchly)
                        ...
                        .pattern("PDP")
                        .pattern("PFP")
                        .criterion(hasItem(ItemInit.feastables),
                                conditionsFromItem(ItemInit.feastables))
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.mango, 9)
                        ...
                        .pattern("M")
                        .criterion(hasItem(BlockInit.MANGO_BLOCK),
                                conditionsFromItem(BlockInit.MANGO_BLOCK))
                        .offerTo(exporter, String.valueOf(
                                Identifier.of("doritosandprime", "mango_from_block")));
                // .offerTo(exporter);
                ...
                ShapedRecipeJsonBuilder
                        .create(itemLookup, RecipeCategory.BUILDING_BLOCKS,
                                BlockInit.MANGO_BLOCK)
                ...
                //
                ShapedRecipeJsonBuilder
                        .create(itemLookup, RecipeCategory.FOOD, ItemInit.flamin_cheetos, 2)
                        .input('W', Items.WHEAT)
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.grimace_shake)
                        ...
                        .pattern("MGS")
                        .pattern(" L ")
                        .criterion(hasItem(Items.MILK_BUCKET),
                                conditionsFromItem(Items.MILK_BUCKET))
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.monster_energy)
                        ...
                        .pattern("BCB")
                        .pattern(" I ")
                        .criterion(hasItem(Items.GLOW_INK_SAC),
                                conditionsFromItem(Items.GLOW_INK_SAC))
                        .criterion(hasItem(Items.SUGAR_CANE),
                                conditionsFromItem(Items.SUGAR_CANE))
                        .offerTo(exporter);

                //
                // OHIO FINAL BOSS BURGER
                //
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.FOOD, ItemInit.ohio_burger)
                        .input('B', Items.BREAD)
                        ...
                        .pattern("AWA")
                        .pattern("RLR")
                        .criterion(hasItem(Items.GOLDEN_APPLE),
